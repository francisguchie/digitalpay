...
public interface MomoConfigurationRepository extends JpaRepository<MomoBridge, Long>, JpaSpecificationExecutor<MomoBridge> {
	
	MomoBridge findOneByName(String name);
}