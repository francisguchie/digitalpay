 ...
 * under the License.
 */
package org.fineract.messagegateway.momo.api;
...
public class MomoApiResource {
	...
	@Autowired
	public MomoApiResource(final TenantsService tenantService) {
		this.tenantService = tenantService ;
	}
	
	@RequestMapping(method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
    public String createMomoBridge(@RequestBody final Tenant tenant) {
    		return "momo-testing";
    }
}
